package Sort; /******************************************************************************
 *  Compilation:  javac Sort.Insertion.java
 *  Execution:    java Sort.Insertion < input.txt
 ...
 *
 *  % java Sort.Insertion < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *
 *  % java Sort.Insertion < words3.txt
...
/**
 *  The {@code Sort.Insertion} class provides static methods for sorting an
